...
public class HistoryList extends ListActivity {
    ...
    private final Handler handler = new Handler() {
        ...
        public void handleMessage(final Message msg) {
            Log.v(Constants.LOGTAG, " " + HistoryList.CLASSTAG + " worker thread done, setup ReviewAdapter");
            progressDialog.dismiss();
            if ((reviews == null) || (reviews.size() == 0)) {
                empty.setText("No Data");
            } else {
                reviewAdapter = new ReviewAdapter(HistoryList.this, reviews);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, HistoryList.MENU_GET_NEXT_PAGE, 0, R.string.menu_get_next_page).setIcon(
            android.R.drawable.ic_menu_more);
        menu.add(0, HistoryList.MENU_CHANGE_CRITERIA, 0, R.string.menu_change_criteria).setIcon(
